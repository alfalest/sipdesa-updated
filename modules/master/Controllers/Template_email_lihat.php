...
use Config\Paths;
class Template_email_lihat extends BaseController
{
    ...
    public function index($param = '', $id_param = '')
    {
        ...
        if($id_param != '' && $id_user){
            ...
            if($data_template_email){
                ...
                return redirect()->to( base_url().'/master/template-email/'.$param);
                exit;
            }
        }
        ...
        $this->data['v']['page'] = 'template_email_lihat';
        $this->data['v']['script'] = 'template_email_lihat';
