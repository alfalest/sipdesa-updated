    ...
    public function index()
    {
        ...
        if($id_template_dokumen != '' && $id_template_dokumen > 0 && isset($jenis_template)){
            if($this->message_info['status']){
                return redirect()->to( base_url().'/master/template-dokumen/'.$jenis_template);
            } else {
                return redirect()->to( base_url().'/master/template-dokumen-edit/'.$jenis_template.'/'.$id_template_dokumen);
            }
        } else {
