...
class Setup_email_edit extends BaseController
{
    ...
    public function index($param = '')
    {
        ...
        if($param != ''){
            $db_setup = $this->tbl_setup_phpmailer->where(['id_setup_phpmailer' => intval($param)])->first();
            if($db_setup){
                $this->data['data_setup'] = $db_setup;
                $new_data = false;
            }
        }

        if($this->session->getFlashdata('inp_val')){
            $this->data['data_setup'] = $this->session->getFlashdata('inp_val');
        }
        ...
        $this->data['v']['page'] = 'setup_email_edit';
        $this->data['v']['script'] = 'setup_email_edit';
