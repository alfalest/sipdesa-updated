  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="<?= base_url() ?>/master/data-diri" class="d-block"><?= (isset($login_session['nama_alias'])) ? $login_session['nama_alias'] : "username" ?></a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-flat" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?= base_url() ?>/master/kode-kata" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>Kode Kata</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?= base_url() ?>/master/data-diri" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>Data Diri</p>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a href="<?= base_url() ?>/master/setting-akun" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>Setting Akun</p>
            </a>
          </li>
