            ...
            <div class="d-flex justify-content-between">
              ...
              <div class="container-fluid p-3">
                  ...
                  <p>Bukan tampilan sebenarnya. tekan print untuk melihat hasil pdf</p>
                    <a class="btn bg-indigo btn-sm rounded-pill px-3 mb-2" href="<?=base_url()?>/master/template-email-print/<?= (isset($data_template_email['jenis_template_email'])) ? str_replace( '_' , '-' , $data_template_email['jenis_template_email']) : ''?>/<?= (isset($data_template_email['id_template_email'])) ? $data_template_email['id_template_email'] : ''?>"><i class="fas fa-print"></i> Print</a>

                    <a class="btn btn-success btn-sm rounded-pill px-3 mb-2" href="<?=base_url()?>/master/template-email-edit/<?= (isset($data_template_email['jenis_template_email'])) ? str_replace( '_' , '-' , $data_template_email['jenis_template_email']) : ''?>/<?= (isset($data_template_email['id_template_email'])) ? $data_template_email['id_template_email'] : ''?>"><i class="fas fa-edit"></i> edit</a>
                  ...
                  <div class="col-8">
                    <?= $data_template_email['judul_email'] ?>
                  </div>
                </div>
              </div>     
...
<div style="margin :auto; padding: 0mm 10mm 10mm 10mm ;  width:210mm; max-width:216mm; background-color:#ffffff;">
    <?php if(isset($data_template_email['isi_email'])) : ?>
    <?= $data_template_email['isi_email'] ?>
    <?php endif; ?>
</div>
