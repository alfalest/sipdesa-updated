              ...
              <div class="card-header pr-3">
                <div class="d-flex justify-content-between">
                  ...
                  <?php if(isset($title_page)) : ?>
                    <a href="<?=base_url()?>/master/template-dokumen" class="btn btn-primary btn-sm rounded-pill"><i class="fas fa-times"></i></a>
                  <?php else : ?>
              ...
              <div id="kartu_keluarga_list" class="col-12">
                ...
                <div class="border shadow-sm round-1 d-flex flex-column mb-3 p-2">
                  <div class="d-flex justify-content-between border-bottom pb-2">
                    ...
                    <div class="">
                      <a href="<?= base_url() ?>/master/<?= $link_edit ?>/<?=$value['id_template_dokumen']?>" class="px-3 py-0 btn btn-sm btn-success round-1 text-sm"><i class="fas fa-edit mr-2"></i> Edit</a>
                    
                    </div>
                  </div>
                  <a href="<?=base_url()?>/master/<?= $link_lihat ?>/<?=$value['id_template_dokumen']?>">
...
<?php else : ?>
          ...
          <a class="btn btn-block my-0 mx-1" href="<?= base_url() ?>/master/template-dokumen/<?= str_replace('_', '-', $key) ?>">
            <div class="d-flex justify-content-between">
