            ...
            <div class="d-flex justify-content-between">
              ...
              <div class="container-fluid p-3">
                  ...
                  <p>Bukan tampilan sebenarnya. tekan print untuk melihat hasil pdf</p>
                    <a class="btn bg-indigo btn-sm rounded-pill px-3 mb-2" href="<?=base_url()?>/master/template-dokumen-print/<?= (isset($data_template_dokumen['jenis_template'])) ? str_replace( '_' , '-' , $data_template_dokumen['jenis_template']) : ''?>/<?= (isset($data_template_dokumen['id_template_dokumen'])) ? $data_template_dokumen['id_template_dokumen'] : ''?>"><i class="fas fa-print"></i> Print</a>

                    <a class="btn btn-success btn-sm rounded-pill px-3 mb-2" href="<?=base_url()?>/master/template-dokumen-edit/<?= (isset($data_template_dokumen['jenis_template'])) ? str_replace( '_' , '-' , $data_template_dokumen['jenis_template']) : ''?>/<?= (isset($data_template_dokumen['id_template_dokumen'])) ? $data_template_dokumen['id_template_dokumen'] : ''?>"><i class="fas fa-edit"></i> edit</a>
