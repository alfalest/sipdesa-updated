            ...
            <div class="card round-1">
              ...
              <div class="row">
                  <div class="col-12 d-flex justify-content-between">
                    ...
                    <div>
                      <a href="<?=base_url()?>/master/setting-akun" class="btn btn-primary btn-sm rounded-pill"><i class="fas fa-times"></i></a>
                    </div>  
                  </div>
                </div>
              <hr>
              <form action="<?=base_url()?>/master/ganti-password-update" id="form_ganti_password" method="post" enctype="multipart/form-data">
    ...
    <div class="modal-content round-1">
      ...
      <div class="modal-footer d-flex">
        <div class="flex-fill">
          <div class="row">
            <div class="col-6">
              <a href="<?= base_url() ?>/master/setting-akun" class="font-weight-bold btn-block btn-primary btn round-1">KEMBALI</a>
            </div>
            <div class="col-6">
