        ...
        <div class="col-12">
          ...
          <div class="card-header pr-3">
            <div class="d-flex justify-content-between">
              <div>
              <p class="font-weight-bold text-lg m-0">Template <?= (isset($title_page) && $title_page != '') ? $title_page : 'Email' ?></p>
              </div>
              <div>
              <a href="<?=base_url()?>/master<?= (isset($link_back)) ? '/'.$link_back : '' ?>" class="btn btn-primary btn-sm rounded-pill"><i class="fas fa-times"></i></a>
              </div>
            </div> 
            </div>
            <form autocomplete="off" action="<?= base_url() ?>/master/template-email-update" method="post">
            <input type="hidden" name="id_template_email" value="<?= (isset($data_template_email['id_template_email']) && $data_template_email['id_template_email'] != '') ? $data_template_email['id_template_email'] : '' ?>">
            <input type="hidden" name="jenis_template_email" value="<?= (isset($data_template_email['jenis_template_email']) && $data_template_email['jenis_template_email'] != '') ? $data_template_email['jenis_template_email'] : '' ?>">
              <!-- /.card-header -->
                  ...
                  <div class="row">
                    <div class="col-12 p-0">
                      <div class="form-group">
                          <textarea name="isi_email" id="compose-textarea" class="form-control round-1" style="height: 300px" required><?= (isset($data_template_email['isi_email']) && $data_template_email['isi_email'] != '') ? $data_template_email['isi_email'] : '' ?></textarea>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="col-12 p-3">
                      <div class="form-group row">
                        <label for="judul_email" class="col-lg-4 text-sm text-muted">Nama Template</label>
                        <div class="col-lg-8">
                          <input value="<?=(isset($data_template_email['judul_email']))? esc($data_template_email['judul_email']) : '' ?>" name="judul_email" type="text" max-length="150" id="judul_email" alt="Masukan nama template" title="Masukan Nama template" class="form-control bw-2 round-1 <?= (isset($invalid_info['judul_email'])) ? 'is-invalid' : 'border-primary' ?>" >
                          <span class="invalid-feedback"><?= (isset($invalid_info['judul_email'])) ? $invalid_info['judul_email'] : '' ?></span>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-lg-8 offset-lg-4">
                          <div class="form-group">
                            <div class="form-check">
                              <input value="1" name="default_email" type="checkbox" id="default_email" class="form-check-input"  <?=(isset($data_template_email['default_email']) && $data_template_email['default_email'] == 1)? 'checked' : '' ?> >
                              <label for="default_email" class="form-chek-label">Jadikan Template utama</label>
                              <span class="invalid-feedback"><?= (isset($invalid_info['default_email'])) ? $invalid_info['default_email'] : '' ?></span>
                            </div>
                          </div>
                        </div>
                      </div>
    ...
    <div class="row">
      ...
      <div class="modal-body">
        <div class="form-group">
          ...
          <input value="" name="input_url_gambar" type="text" max-length="150" id="input_url_gambar" alt="Masukan url gambar" title="Masukan url gambar" class="form-control bw-2 round-1 <?= (isset($invalid_info['judul_email'])) ? 'is-invalid' : 'border-primary' ?>" >
