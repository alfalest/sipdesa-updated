      ...
      <div class="col-12 pt-2">
        <div class="card round-1">
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-12">
                <a class="btn btn-block my-0 mx-1" href="<?= base_url() ?>/master/setup-email">
                  <div class="d-flex justify-content-between">
                    <div>Setup PHPMailer</div>
                    <div>
                ...
                <hr>
                <a class="btn btn-block my-0 mx-1" href="<?= base_url() ?>/master/template-email">
                  <div class="d-flex justify-content-between">
