      ...
      <div class="col-12 pt-2">
         ...
         <div class="card-header pr-3">
            <div class="d-flex justify-content-between">
              <div>
              <p class="font-weight-bold text-lg m-0">User Detail</p>
              </div>
              <div>
              <a href="<?=base_url()?>/master/user" class="btn btn-primary btn-sm rounded-pill"><i class="fas fa-times"></i></a>
              </div>
            </div> 
            </div>
         ...
         <div class="card-body">
          <div class="row">
              <div class="col-12">
              <a href="<?=base_url()?>/master/user-edit<?=(isset($data_diri['id_user'])) ? '/'.$data_diri['id_user'] : '' ?>" class="btn-sm px-3 btn btn-primary rounded-pill"><i class="fas fa-edit mr-3"></i> Edit</a>
              </div>
          </div>
          <hr>
