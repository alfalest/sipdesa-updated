...
class Surat_belum_memiliki_rumah_editor_update extends BaseController
{
    public $post;
    ...
    public function index()
    {
        ...
        $set_data = [
            ...
            'jenis_surat' => 'surat_keterangan_belum_memiliki_rumah',
            'teks_isi_surat' => '',
            'nomor_surat' => '',
            'nama_penanda_tangan' => '',
        ...
        if (isset($this->post['id_surat']) && $this->post['id_surat'] != '') {
            $data_surat_belum_memiliki_rumah = $this->tbl_surat_belum_memiliki_rumah->where(['id_surat_belum_memiliki_rumah' => $this->post['id_surat'], 'status_surat_belum_memiliki_rumah' => 2])->first();
            if ($data_surat_belum_memiliki_rumah) {
                $id_surat_belum_memiliki_rumah =  $data_surat_belum_memiliki_rumah['id_surat_belum_memiliki_rumah'];
                $set_data['id_surat'] = $data_surat_belum_memiliki_rumah['id_surat_belum_memiliki_rumah'];
            } else {
                $valid = false;
        ...
        if ($id_surat_belum_memiliki_rumah != '' && $id_surat_belum_memiliki_rumah > 0) {
            if (isset($id_data_surat) && $id_data_surat != '' && $this->message_info['status']) {
                ...
                return redirect()->to(base_url() . '/operator/surat-belum-memiliki-rumah-editor/' . $id_surat_belum_memiliki_rumah);
            }
        } else {
            //return redirect()->to( base_url().'/operator/surat-belum_memiliki_rumah/diterima');
            return redirect()->to(base_url() . '/operator/surat-belum-memiliki-rumah/diterima');
        }
        exit;
    }
