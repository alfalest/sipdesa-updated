...
class Surat_ket_tidak_mampu_edit extends BaseController
{
    ...
    public function index($param = '')
    {
        ...
        $this->list_kode_kata = ['tempat_dilahirkan', 'jenis_ket_tidak_mampu', 'penolong_ket_tidak_mampu', 'jenis_kelamin', 'agama', 'jenis_pekerjaan', 'status_perkawinan', 'gol_darah'];
        ...
        if ($param != '' && $id_user) {
            $data_surat_ket_tidak_mampu = $this->tbl_surat_ket_tidak_mampu->where(['id_surat_ket_tidak_mampu' => intval($param), 'status_surat_ket_tidak_mampu' => 1])->first();
        }
        ...
        if ($this->session->getFlashdata('inp_val')) {
            foreach ($this->session->getFlashdata('inp_val') as $key => $value) {
                if ($key != 'id_surat_ket_tidak_mampu') {
                    $this->data['data_surat_ket_tidak_mampu'][$key] = $value;
                }
            }
        }
        ...
        if (isset($this->data['data_surat_ket_tidak_mampu'])) {
            $this->data['data_surat_ket_tidak_mampu'] = $this->arr_wilayah($this->data['data_surat_ket_tidak_mampu'], '_anak');
            $this->data['data_surat_ket_tidak_mampu'] = $this->arr_wilayah($this->data['data_surat_ket_tidak_mampu'], '_ayah');
            $this->data['data_surat_ket_tidak_mampu'] = $this->arr_wilayah($this->data['data_surat_ket_tidak_mampu'], '_ibu');
        }
