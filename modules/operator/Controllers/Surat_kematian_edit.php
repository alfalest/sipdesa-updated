...
class Surat_kematian_edit extends BaseController
{
    ...
    public function index($param = '')
    {
        ...
        $this->list_kode_kata = ['tempat_dilahirkan', 'jenis_kematian', 'penolong_kematian', 'jenis_kelamin', 'agama', 'jenis_pekerjaan', 'status_perkawinan', 'gol_darah'];
        ...
        if ($param != '' && $id_user) {
            $data_surat_kematian = $this->tbl_surat_kematian->where(['id_surat_kematian' => intval($param), 'status_surat_kematian' => 1])->first();
        }
        ...
        if ($this->session->getFlashdata('inp_val')) {
            foreach ($this->session->getFlashdata('inp_val') as $key => $value) {
                if ($key != 'id_surat_kematian') {
                    $this->data['data_surat_kematian'][$key] = $value;
                }
            }
        }
        ...
        if (isset($this->data['data_surat_kematian'])) {
            $this->data['data_surat_kematian'] = $this->arr_wilayah($this->data['data_surat_kematian'], '_anak');
            $this->data['data_surat_kematian'] = $this->arr_wilayah($this->data['data_surat_kematian'], '_ayah');
            $this->data['data_surat_kematian'] = $this->arr_wilayah($this->data['data_surat_kematian'], '_ibu');
        }
