...
use Config\Paths;
class Template_dokumen_lihat extends BaseController
{
    ...
    public function index($param = '', $id_param = '')
    {
        ...
        if($id_param != '' && $id_user){
            ...
            if($data_template_dokumen){
                ...
                return redirect()->to( base_url().'/operator/template-dokumen/'.$param);
                exit;
            }
        }
        ...
        $this->data['v']['page'] = 'template_dokumen_lihat';
        $this->data['v']['script'] = 'template_dokumen_lihat';
