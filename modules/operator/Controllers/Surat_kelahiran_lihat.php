...
class Surat_kelahiran_lihat extends BaseController
{
    ...
    public function index($param = '')
    {
        ...
        if($param != '' && $id_user){
            $data_surat_kelahiran = $this->tbl_surat_kelahiran->where(['id_surat_kelahiran' => intval($param)])->first();
        }

        if($data_surat_kelahiran){
            $this->data['data_surat_kelahiran'] = $data_surat_kelahiran;
    
            if(isset($this->data['data_surat_kelahiran']['id_user'])){
                $this->data['data_user_pemohon'] = $this->tbl_user->where(['id_user' => $this->data['data_surat_kelahiran']['id_user']])->first();
                $this->data['data_diri_pemohon'] = $this->tbl_data_diri->where(['id_user' => $this->data['data_surat_kelahiran']['id_user']])->first();
