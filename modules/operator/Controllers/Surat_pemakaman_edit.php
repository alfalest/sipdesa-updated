...
class Surat_pemakaman_edit extends BaseController
{
    ...
    public function index($param = '')
    {
        ...
        $this->list_kode_kata = ['tempat_dilahirkan', 'jenis_pemakaman', 'penolong_pemakaman', 'jenis_kelamin', 'agama', 'jenis_pekerjaan', 'status_perkawinan', 'gol_darah'];
        ...
        if ($param != '' && $id_user) {
            $data_surat_pemakaman = $this->tbl_surat_pemakaman->where(['id_surat_pemakaman' => intval($param), 'status_surat_pemakaman' => 1])->first();
        }
        ...
        if ($this->session->getFlashdata('inp_val')) {
            foreach ($this->session->getFlashdata('inp_val') as $key => $value) {
                if ($key != 'id_surat_pemakaman') {
                    $this->data['data_surat_pemakaman'][$key] = $value;
                }
            }
        }
        ...
        if (isset($this->data['data_surat_pemakaman'])) {
            $this->data['data_surat_pemakaman'] = $this->arr_wilayah($this->data['data_surat_pemakaman'], '_anak');
            $this->data['data_surat_pemakaman'] = $this->arr_wilayah($this->data['data_surat_pemakaman'], '_ayah');
            $this->data['data_surat_pemakaman'] = $this->arr_wilayah($this->data['data_surat_pemakaman'], '_ibu');
        }
