...
class Surat_catatan_kepolisian_edit extends BaseController
{
    ...
    public function index($param = '')
    {
        ...
        $this->list_kode_kata = ['tempat_dilahirkan', 'jenis_catatan_kepolisian', 'penolong_catatan_kepolisian', 'jenis_kelamin', 'agama', 'jenis_pekerjaan', 'status_perkawinan', 'gol_darah'];
        ...
        if ($param != '' && $id_user) {
            $data_surat_catatan_kepolisian = $this->tbl_surat_catatan_kepolisian->where(['id_surat_catatan_kepolisian' => intval($param), 'status_surat_catatan_kepolisian' => 1])->first();
        }
        ...
        if ($this->session->getFlashdata('inp_val')) {
            foreach ($this->session->getFlashdata('inp_val') as $key => $value) {
                if ($key != 'id_surat_catatan_kepolisian') {
                    $this->data['data_surat_catatan_kepolisian'][$key] = $value;
                }
            }
        }
        ...
        if (isset($this->data['data_surat_catatan_kepolisian'])) {
            $this->data['data_surat_catatan_kepolisian'] = $this->arr_wilayah($this->data['data_surat_catatan_kepolisian'], '_anak');
            $this->data['data_surat_catatan_kepolisian'] = $this->arr_wilayah($this->data['data_surat_catatan_kepolisian'], '_ayah');
            $this->data['data_surat_catatan_kepolisian'] = $this->arr_wilayah($this->data['data_surat_catatan_kepolisian'], '_ibu');
        }
