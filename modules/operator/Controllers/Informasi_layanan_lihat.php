...
use Config\Paths;
class Informasi_layanan_lihat extends BaseController
{
    ...
    public function index($param = '', $id_param = '')
    {
        ...
        if($id_param != '' && $id_user){
            ...
            if($data_informasi_layanan){
                ...
                return redirect()->to( base_url().'/operator/informasi-layanan/'.$param);
                exit;
            }
        }
        ...
        $this->data['v']['page'] = 'informasi_layanan_lihat';
        $this->data['v']['script'] = 'informasi_layanan_lihat';
