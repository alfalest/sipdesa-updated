...
class Surat_pencari_kerja_editor_update extends BaseController
{
    public $post;
    ...
    public function index()
    {
        ...
        $set_data = [
            ...
            'jenis_surat' => 'surat_keterangan_pencari_kerja',
            'teks_isi_surat' => '',
            'nomor_surat' => '',
            'nama_penanda_tangan' => '',
        ...
        if (isset($this->post['id_surat']) && $this->post['id_surat'] != '') {
            $data_surat_pencari_kerja = $this->tbl_surat_pencari_kerja->where(['id_surat_pencari_kerja' => $this->post['id_surat'], 'status_surat_pencari_kerja' => 2])->first();
            if ($data_surat_pencari_kerja) {
                $id_surat_pencari_kerja =  $data_surat_pencari_kerja['id_surat_pencari_kerja'];
                $set_data['id_surat'] = $data_surat_pencari_kerja['id_surat_pencari_kerja'];
            } else {
                $valid = false;
        ...
        if ($id_surat_pencari_kerja != '' && $id_surat_pencari_kerja > 0) {
            if (isset($id_data_surat) && $id_data_surat != '' && $this->message_info['status']) {
                ...
                return redirect()->to(base_url() . '/operator/surat-pencari-kerja-editor/' . $id_surat_pencari_kerja);
            }
        } else {
            //return redirect()->to( base_url().'/operator/surat-pencari_kerja/diterima');
            return redirect()->to(base_url() . '/operator/surat-pencari-kerja/diterima');
        }
        exit;
    }
