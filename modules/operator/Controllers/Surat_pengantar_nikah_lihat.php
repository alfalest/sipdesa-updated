...
class Surat_pengantar_nikah_lihat extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->arr_postfix = [ '_pasangan' => 'Pemohon',  '_pemohon' => 'Pasangan', '_ayah' => 'Ayah', '_ibu' => 'Ibu' ];
    }
    ...
    public function index($param = '')
    {
        ...
        if($param != '' && $id_user){
            $data_surat_pengantar_nikah = $this->tbl_surat_pengantar_nikah->where(['id_surat_pengantar_nikah' => intval($param)])->first();
        }

        if($data_surat_pengantar_nikah){
            $this->data['data_surat_pengantar_nikah'] = $data_surat_pengantar_nikah;
    
            if(isset($this->data['data_surat_pengantar_nikah']['id_user'])){
                $this->data['data_user_pemohon'] = $this->tbl_user->where(['id_user' => $this->data['data_surat_pengantar_nikah']['id_user']])->first();
                $this->data['data_diri_pemohon'] = $this->tbl_data_diri->where(['id_user' => $this->data['data_surat_pengantar_nikah']['id_user']])->first();
