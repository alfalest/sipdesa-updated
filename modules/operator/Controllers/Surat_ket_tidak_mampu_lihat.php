...
class Surat_ket_tidak_mampu_lihat extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->arr_postfix = ['_anak' => 'Anak', '_ayah' => 'Ayah', '_ibu' => 'Ibu', '_ket_tidak_mampu' => 'Ket Tidak Mampu'];
    }
    ...
    public function index($param = '')
    {
        ...
        if ($param != '' && $id_user) {
            $data_surat_ket_tidak_mampu = $this->tbl_surat_ket_tidak_mampu->where(['id_surat_ket_tidak_mampu' => intval($param)])->first();
        }

        if ($data_surat_ket_tidak_mampu) {
            $this->data['data_surat_ket_tidak_mampu'] = $data_surat_ket_tidak_mampu;

            if (isset($this->data['data_surat_ket_tidak_mampu']['id_user'])) {
                $this->data['data_user_pemohon'] = $this->tbl_user->where(['id_user' => $this->data['data_surat_ket_tidak_mampu']['id_user']])->first();
                $this->data['data_diri_pemohon'] = $this->tbl_data_diri->where(['id_user' => $this->data['data_surat_ket_tidak_mampu']['id_user']])->first();
        ...
        if (!isset($this->data['data_surat_ket_tidak_mampu']['link_foto_kk']) || $this->data['data_surat_ket_tidak_mampu']['link_foto_kk'] == '') {
            if (isset($data_surat_ket_tidak_mampu['link_foto_kk'])) {
                $this->data['data_surat_ket_tidak_mampu']['link_foto_kk'] = $data_surat_ket_tidak_mampu['link_foto_kk'];
            }
        }

        //ambil data wilayah untuk membuat option
        if (isset($this->data['data_surat_ket_tidak_mampu'])) {
            foreach ($this->arr_postfix as $key => $value) {
                $this->data['data_surat_ket_tidak_mampu'] = $this->wilayah($this->data['data_surat_ket_tidak_mampu'], $key);
                $this->data['data_surat_ket_tidak_mampu'] = $this->kode_kata($this->data['data_surat_ket_tidak_mampu'], $key);
                $this->data['data_surat_ket_tidak_mampu'] = $this->negara($this->data['data_surat_ket_tidak_mampu'], $key);
                $this->data['data_surat_ket_tidak_mampu'] = $this->kode_kata($this->data['data_surat_ket_tidak_mampu']);
            }
        }
        ...
        $this->data['v']['page'] = 'surat_ket_tidak_mampu_lihat';
        $this->data['v']['script'] = 'surat_ket_tidak_mampu_lihat';
