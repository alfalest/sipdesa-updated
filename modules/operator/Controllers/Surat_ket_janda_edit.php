...
class Surat_ket_janda_edit extends BaseController
{
    ...
    public function index($param = '')
    {
        ...
        $this->list_kode_kata = ['tempat_dilahirkan', 'jenis_ket_janda', 'penolong_ket_janda', 'jenis_kelamin', 'agama', 'jenis_pekerjaan', 'status_perkawinan', 'gol_darah'];
        ...
        if ($param != '' && $id_user) {
            $data_surat_ket_janda = $this->tbl_surat_ket_janda->where(['id_surat_ket_janda' => intval($param), 'status_surat_ket_janda' => 1])->first();
        }
        ...
        if ($this->session->getFlashdata('inp_val')) {
            foreach ($this->session->getFlashdata('inp_val') as $key => $value) {
                if ($key != 'id_surat_ket_janda') {
                    $this->data['data_surat_ket_janda'][$key] = $value;
                }
            }
        }
        ...
        if (isset($this->data['data_surat_ket_janda'])) {
            $this->data['data_surat_ket_janda'] = $this->arr_wilayah($this->data['data_surat_ket_janda'], '_anak');
            $this->data['data_surat_ket_janda'] = $this->arr_wilayah($this->data['data_surat_ket_janda'], '_ayah');
            $this->data['data_surat_ket_janda'] = $this->arr_wilayah($this->data['data_surat_ket_janda'], '_ibu');
        }
        ...
        $this->data['v']['page'] = 'surat_ket_janda_edit';
        $this->data['v']['script'] = 'surat_ket_janda_edit';
