...
class Surat_ket_janda_editor_update extends BaseController
{
    public $post;
    ...
    public function index()
    {
        ...
        $set_data = [
            ...
            'jenis_surat' => 'surat_keterangan_ket_janda',
            'teks_isi_surat' => '',
            'nomor_surat' => '',
            'nama_penanda_tangan' => '',
        ...
        if (isset($this->post['id_surat']) && $this->post['id_surat'] != '') {
            $data_surat_ket_janda = $this->tbl_surat_ket_janda->where(['id_surat_ket_janda' => $this->post['id_surat'], 'status_surat_ket_janda' => 2])->first();
            if ($data_surat_ket_janda) {
                $id_surat_ket_janda =  $data_surat_ket_janda['id_surat_ket_janda'];
                $set_data['id_surat'] = $data_surat_ket_janda['id_surat_ket_janda'];
            } else {
                $valid = false;
        ...
        if ($id_surat_ket_janda != '' && $id_surat_ket_janda > 0) {
            if (isset($id_data_surat) && $id_data_surat != '' && $this->message_info['status']) {
                ...
                return redirect()->to(base_url() . '/operator/surat-ket-janda-editor/' . $id_surat_ket_janda);
            }
        } else {
            //return redirect()->to( base_url().'/operator/surat-ket_janda/diterima');
            return redirect()->to(base_url() . '/operator/surat-ket-janda/diterima');
        }
        exit;
    }
