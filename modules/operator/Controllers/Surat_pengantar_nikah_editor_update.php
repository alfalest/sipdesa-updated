...
use Config\Paths;
class Surat_pengantar_nikah_editor_update extends BaseController
{
    public $post;
    ...
    public function index()
    {
        ...
        $set_data = [
            ...
            'jenis_surat' => 'surat_pengantar_nikah',
            'teks_isi_surat' => '',
            'nomor_surat' => '',
            'nama_penanda_tangan' => '',
        ...
        if(isset($this->post['id_surat']) && $this->post['id_surat'] != '' ){
            $data_surat_pengantar_nikah = $this->tbl_surat_pengantar_nikah->where(['id_surat_pengantar_nikah' => $this->post['id_surat'] , 'status_surat_pengantar_nikah' => 2])->first();
            if($data_surat_pengantar_nikah){
                $id_surat_pengantar_nikah =  $data_surat_pengantar_nikah['id_surat_pengantar_nikah'];
                $set_data['id_surat'] = $data_surat_pengantar_nikah['id_surat_pengantar_nikah'];
        ...
        if($id_surat_pengantar_nikah != '' && $id_surat_pengantar_nikah > 0){
            if(isset($id_data_surat) && $id_data_surat != '' && $this->message_info['status']){
               ...
               // return redirect()->to( base_url().'/operator/data-surat-lihat/'.$id_data_surat);
                ...
                return redirect()->to( base_url().'/operator/surat-pengantar-nikah-editor/'.$id_surat_pengantar_nikah);
            }
        } else {
            //return redirect()->to( base_url().'/operator/surat-pengantar-nikah/diterima');
            return redirect()->to( base_url().'/operator/surat-pengantar-nikah/diterima');
        }
        exit;
    }
