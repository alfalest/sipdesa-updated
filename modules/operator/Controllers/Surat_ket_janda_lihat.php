...
class Surat_ket_janda_lihat extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->arr_postfix = ['_ket_janda' => 'Ket Janda'];
    }
    ...
    public function index($param = '')
    {
        ...
        if ($param != '' && $id_user) {
            $data_surat_ket_janda = $this->tbl_surat_ket_janda->where(['id_surat_ket_janda' => intval($param)])->first();
        }

        if ($data_surat_ket_janda) {
            $this->data['data_surat_ket_janda'] = $data_surat_ket_janda;

            if (isset($this->data['data_surat_ket_janda']['id_user'])) {
                $this->data['data_user_pemohon'] = $this->tbl_user->where(['id_user' => $this->data['data_surat_ket_janda']['id_user']])->first();
                $this->data['data_diri_pemohon'] = $this->tbl_data_diri->where(['id_user' => $this->data['data_surat_ket_janda']['id_user']])->first();
        ...
        if (!isset($this->data['data_surat_ket_janda']['link_foto_kk']) || $this->data['data_surat_ket_janda']['link_foto_kk'] == '') {
            if (isset($data_surat_ket_janda['link_foto_kk'])) {
                $this->data['data_surat_ket_janda']['link_foto_kk'] = $data_surat_ket_janda['link_foto_kk'];
            }
        }
