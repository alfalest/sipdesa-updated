                ...
                <div class="d-flex justify-content-between border-bottom pb-2">
                  ...
                  <div class="">
                    <?php if ($data_surat_kelahiran['status_surat_kelahiran'] == 1) : ?>
                      <a href="<?= base_url() ?>/operator/surat-kelahiran-edit/<?= $data_surat_kelahiran['id_surat_kelahiran'] ?>" class="px-3 py-0 btn btn-sm btn-success round-1 text-sm"><i class="fas fa-edit mr-2"></i> Verifikasi</a>

                    <?php elseif ($data_surat_kelahiran['status_surat_kelahiran'] == 2) : ?>
                      <a href="<?= base_url() ?>/operator/surat-kelahiran-editor/<?= $data_surat_kelahiran['id_surat_kelahiran'] ?>" class="px-3 py-0 btn btn-sm bg-indigo round-1 text-sm"><i class="fas fa-print mr-2"></i> Redaksi Editor</a>
                    <?php endif; ?>
                  </div>
                </div>
