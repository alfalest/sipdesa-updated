                ...
                <div class="d-flex justify-content-between border-bottom pb-2">
                  ...
                  <div class="">
                    <?php if ($data_surat_pencari_kerja['status_surat_pencari_kerja'] == 1) : ?>
                      <a href="<?= base_url() ?>/operator/surat-pencari-kerja-edit/<?= $data_surat_pencari_kerja['id_surat_pencari_kerja'] ?>" class="px-3 py-0 btn btn-sm btn-success round-1 text-sm"><i class="fas fa-edit mr-2"></i> Verifikasi</a>

                    <?php elseif ($data_surat_pencari_kerja['status_surat_pencari_kerja'] == 2) : ?>
                      <a href="<?= base_url() ?>/operator/surat-pencari-kerja-editor/<?= $data_surat_pencari_kerja['id_surat_pencari_kerja'] ?>" class="px-3 py-0 btn btn-sm bg-indigo round-1 text-sm"><i class="fas fa-print mr-2"></i> Redaksi Editor</a>
                    <?php endif; ?>
                  </div>
                </div>
                <div class="">
                  ...
                  <table class="table">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?= (isset($data_surat_pencari_kerja['tujuan_membuat_surat_pencari_kerja'])) ? $data_surat_pencari_kerja['tujuan_membuat_surat_pencari_kerja'] : '' ?></td>
                      </tr>
                      <tr>
                        <td>Tempat Lahir</td>
