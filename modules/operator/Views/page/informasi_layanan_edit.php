        ...
        <div class="col-12">
          ...
          <div class="card-header pr-3">
            <div class="d-flex justify-content-between">
              <div>
              <p class="font-weight-bold text-lg m-0">Informasi Layanan <?= (isset($title_page) && $title_page != '') ? $title_page : 'Dokumen' ?></p>
              </div>
              <div>
            ...
            <form autocomplete="off" action="<?= base_url() ?>/operator/informasi-layanan-update" method="post">
            <input type="hidden" name="id_informasi_layanan" value="<?= (isset($data_informasi_layanan['id_informasi_layanan']) && $data_informasi_layanan['id_informasi_layanan'] != '') ? $data_informasi_layanan['id_informasi_layanan'] : '' ?>">
            <input type="hidden" name="jenis_informasi" value="<?= (isset($data_informasi_layanan['jenis_informasi']) && $data_informasi_layanan['jenis_informasi'] != '') ? $data_informasi_layanan['jenis_informasi'] : '' ?>">
              <!-- /.card-header -->
                  ...
                  <div class="row">
                    <div class="col-12 p-0">
                      <div class="form-group">
                          <textarea name="informasi_layanan" id="compose-textarea" class="form-control round-1" style="height: 300px" required><?= (isset($data_informasi_layanan['informasi_layanan']) && $data_informasi_layanan['informasi_layanan'] != '') ? $data_informasi_layanan['informasi_layanan'] : '' ?></textarea>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-12 p-3">
                      <div class="form-group row">
                        <label for="nama_informasi" class="col-lg-4 text-sm text-muted">Nama Informasi</label>
                        <div class="col-lg-8">
                          <input value="<?=(isset($data_informasi_layanan['nama_informasi']))? esc($data_informasi_layanan['nama_informasi']) : '' ?>" name="nama_informasi" type="text" max-length="150" id="nama_informasi" alt="Masukan nama template" title="Masukan Nama template" class="form-control bw-2 round-1 <?= (isset($invalid_info['nama_informasi'])) ? 'is-invalid' : 'border-primary' ?>" >
                          <span class="invalid-feedback"><?= (isset($invalid_info['nama_informasi'])) ? $invalid_info['nama_informasi'] : '' ?></span>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-lg-8 offset-lg-4">
                          <div class="form-group">
                            <div class="form-check">
                              <input value="1" name="default_informasi" type="checkbox" id="default_informasi" class="form-check-input"  <?=(isset($data_informasi_layanan['default_informasi']) && $data_informasi_layanan['default_informasi'] == 1)? 'checked' : '' ?> >
                              <label for="default_informasi" class="form-chek-label">Jadikan Informasi utama</label>
                              <span class="invalid-feedback"><?= (isset($invalid_info['default_informasi'])) ? $invalid_info['default_informasi'] : '' ?></span>
                            </div>
                          </div>
                        </div>
                      </div>
    ...
    <div class="row">
      ...
      <div class="modal-body">
        <div class="form-group">
          ...
          <input value="" name="input_url_gambar" type="text" max-length="150" id="input_url_gambar" alt="Masukan url gambar" title="Masukan url gambar" class="form-control bw-2 round-1 <?= (isset($invalid_info['nama_informasi'])) ? 'is-invalid' : 'border-primary' ?>" >
