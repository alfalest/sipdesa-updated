    ...
    <!-- Main content -->
      <div class="container">
        ...
        <div class="card-title">
          <h5 class="font-weight-bold">Detail Kartu Keluarga</h5>
        </div>
        <div class="card-tools">
          <div>
          <a href="<?=base_url()?>/operator/kartu-keluarga" class="text-sm btn btn-primary btn-sm rounded-pill">
                ...
                <div class="border shadow-sm round-1 d-flex flex-column mb-3 p-2">
                  <div class="d-flex justify-content-between border-bottom pb-2">
                    ...
                    <?php if($data_kk['status_perubahan_kk'] == 1) : ?>
                      <a href="<?= base_url() ?>/operator/kartu-keluarga-edit/<?=$data_kk['id_perubahan_kk']?>" class="px-3 py-0 btn btn-sm btn-success round-1 text-sm"><i class="fas fa-edit"></i> Verifikasi</a>
                    <?php endif; ?>
                    </div>
                  </div>
                  ...
                  <div>
                   <table class="table">
                      <tbody>
                        <tr>
                          <td>Nomor KK</td>
                          <td><span style="letter-spacing:0.15em" class="font-weight-bold"><?=(isset($data_kk['nkk']))? $data_kk['nkk'] : '' ?></span></td>
                        </tr>
                        <tr>
