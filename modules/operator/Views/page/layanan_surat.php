      ...
      <div class="col-12 pt-2">
        <div class="card round-1">
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-12">
                <a class="btn btn-block my-0 mx-1" href="<?= base_url() ?>/operator/surat-kelahiran">
                ...
                <hr>
                <a class="btn btn-block my-0 mx-1" href="<?= base_url() ?>/operator/surat-pengantar-nikah">
                  <div class="d-flex justify-content-between">
                ...
                <hr>
                <a class="btn btn-block my-0 mx-1" href="<?= base_url() ?>/operator/surat-kematian">
                  <div class="d-flex justify-content-between">
                ...
                <hr>
                <a class="btn btn-block my-0 mx-1" href="<?= base_url() ?>/operator/surat-pemakaman">
                  <div class="d-flex justify-content-between">
                ...
                <hr>
                <a class="btn btn-block my-0 mx-1" href="<?= base_url() ?>/operator/surat-catatan-kepolisian">
                  <div class="d-flex justify-content-between">
                ...
                <hr>
                <a class="btn btn-block my-0 mx-1" href="<?= base_url() ?>/operator/surat-pencari-kerja">
                  <div class="d-flex justify-content-between">
                ...
                <hr>
                <a class="btn btn-block my-0 mx-1" href="<?= base_url() ?>/operator/surat-belum-memiliki-rumah">
                  <div class="d-flex justify-content-between">
                ...
                <hr>
                <a class="btn btn-block my-0 mx-1" href="<?= base_url() ?>/operator/surat-ket-tidak-mampu">
                  <div class="d-flex justify-content-between">
                ...
                <hr>
                <a class="btn btn-block my-0 mx-1" href="<?= base_url() ?>/operator/surat-ket-janda">
                  <div class="d-flex justify-content-between">
                    <div>Surat Keterangan Status Janda</div>
                    <div>
