                ...
                <div class="d-flex justify-content-between border-bottom pb-2">
                  ...
                  <div class="">
                    <?php if ($data_surat_catatan_kepolisian['status_surat_catatan_kepolisian'] == 1) : ?>
                      <a href="<?= base_url() ?>/operator/surat-catatan-kepolisian-edit/<?= $data_surat_catatan_kepolisian['id_surat_catatan_kepolisian'] ?>" class="px-3 py-0 btn btn-sm btn-success round-1 text-sm"><i class="fas fa-edit mr-2"></i> Verifikasi</a>

                    <?php elseif ($data_surat_catatan_kepolisian['status_surat_catatan_kepolisian'] == 2) : ?>
                      <a href="<?= base_url() ?>/operator/surat-catatan-kepolisian-editor/<?= $data_surat_catatan_kepolisian['id_surat_catatan_kepolisian'] ?>" class="px-3 py-0 btn btn-sm bg-indigo round-1 text-sm"><i class="fas fa-print mr-2"></i> Redaksi Editor</a>
                    <?php endif; ?>
                  </div>
                </div>
                <div class="">
                  ...
                  <table class="table">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?= (isset($data_surat_catatan_kepolisian['tujuan_membuat_surat_catatan_kepolisian'])) ? $data_surat_catatan_kepolisian['tujuan_membuat_surat_catatan_kepolisian'] : '' ?></td>
                      </tr>
                      <tr>
                        <td>Tempat Lahir</td>
