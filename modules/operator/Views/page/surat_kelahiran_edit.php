        ...
        <div class="row">
          <div class="col-12 pt-2">
            ...
            <div class="d-flex justify-content-between">
              <div>
              <p class="font-weight-bold text-lg m-0">Verifikasi Surat Keterangan Kelahiran</p>
              </div>
              <div>
              <a href="<?=base_url()?>/operator/surat-kelahiran" class="btn btn-primary btn-sm rounded-pill"><i class="fas fa-times"></i></a>
              </div>
            </div> 
            </div>
              <div class="card-body">                
              ...
              <form action="<?=base_url()?>/operator/surat-kelahiran-update" id="surat_kelahiran" method="post" enctype="multipart/form-data">
              <input value="<?=(isset($data_surat_kelahiran['id_surat_kelahiran']))? esc($data_surat_kelahiran['id_surat_kelahiran']) : '' ?>" name="id_surat_kelahiran" type="hidden"  id="id_surat_kelahiran">
              <div class="form-group row">
                  ...
                  <div class="col-lg-8">
                    <div class="custom-control custom-radio">
                      <input type="radio" name="status_surat_kelahiran" id="status_surat_kelahiran_terima" class="custom-control-input custom-control-input-success" value="2" <?=(isset($data_surat_kelahiran['status_surat_kelahiran']) && $data_surat_kelahiran['status_surat_kelahiran'] == 2 )?  'checked' : '' ?> required>
                      <label for="status_surat_kelahiran_terima" class="custom-control-label">Diterima</label>    
                    </div>
                    <div class="custom-control custom-radio">
                      <input type="radio" name="status_surat_kelahiran" id="status_surat_kelahiran_tolak" class="custom-control-input custom-control-input-danger" value="3" <?=(isset($data_surat_kelahiran['status_surat_kelahiran']) && $data_surat_kelahiran['status_surat_kelahiran'] == 3 )?  'checked' : '' ?>>
                      <label for="status_surat_kelahiran_tolak" class="custom-control-label">Ditolak</label>    
                    </div>
                  </div>
              </div>
                  <div class="form-group row">
                ...
                <div class="col-lg-8">
                <textarea name="keterangan_operator" id="keterangan_operator" class="form-control bw-2 border-primary round-1" style="min-height:40px; max-height:100px;"><?=(isset($data_surat_kelahiran['keterangan_operator']))? esc($data_surat_kelahiran['keterangan_operator']) : '' ?></textarea>
                </div>
              </div>
              <hr>
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-8">
                <textarea name="keterangan_tiket" id="keterangan_tiket" class="form-control bw-2 border-primary round-1" style="min-height:40px; max-height:100px;"><?=(isset($data_surat_kelahiran['keterangan_tiket']))? esc($data_surat_kelahiran['keterangan_tiket']) : '' ?></textarea>
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-8">
                  <input value="<?=(isset($data_surat_kelahiran['tanggal_kunjungan_tiket']))? $data_surat_kelahiran['tanggal_kunjungan_tiket'] : '' ?>" name="tanggal_kunjungan_tiket" type="date" id="tanggal_kunjungan_tiket" class="form-control bw-2 border-primary round-1"  >
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-lg-8">
                  <div class="row">
                    <div class="col-6">
                      ...
                      <input value="<?=(isset($data_surat_kelahiran['waktu_mulai_tiket']))? $data_surat_kelahiran['waktu_mulai_tiket'] : '' ?>" name="waktu_mulai_tiket" type="time" id="waktu_mulai_tiket" class="form-control bw-2 border-primary round-1"  >
                    </div>
                    <div class="col-6">
                      <span class="text-muted text-sm">Selesai</span>
                      <input value="<?=(isset($data_surat_kelahiran['waktu_selesai_tiket']))? $data_surat_kelahiran['waktu_selesai_tiket'] : '' ?>" name="waktu_selesai_tiket" type="time" id="waktu_selesai_tiket" class="form-control bw-2 border-primary round-1"  >
                    </div>
                  </div>
                </div>
              </div>
