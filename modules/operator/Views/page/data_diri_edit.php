            ...
            <div class="card round-1">
              ...
              <div class="row">
                  <div class="col-12 d-flex justify-content-between">
                    ...
                    <div>
                      <a href="<?=base_url()?>/operator/data-diri" class="btn btn-primary btn-sm rounded-pill"><i class="fas fa-times"></i></a>
                    </div>  
                  </div>
                </div>
              <hr>
              <form action="<?=base_url()?>/operator/data-diri-update" id="data_diri" method="post" enctype="multipart/form-data">
    ...
    <div class="modal-content round-1">
      ...
      <div class="modal-footer d-flex">
        <div class="flex-fill">
          <div class="row">
            <div class="col-6">
              <a href="<?= base_url() ?>/operator/data-diri<?= (isset($data_diri['id_user'])) ? '/'.$data_diri['id_user'] : '' ?>" class="font-weight-bold btn-block btn-primary btn round-1">KEMBALI</a>
            </div>
            <div class="col-6">
