            ...
            <div class="d-flex justify-content-between">
              ...
              <div class="container-fluid p-3">
                  ...
                  <p>Bukan tampilan sebenarnya. tekan print untuk melihat hasil pdf</p>
                    <a class="btn bg-indigo btn-sm rounded-pill px-3 mb-2" href="<?=base_url()?>/operator/informasi-layanan-print/<?= (isset($data_informasi_layanan['jenis_informasi'])) ? str_replace( '_' , '-' , $data_informasi_layanan['jenis_informasi']) : ''?>/<?= (isset($data_informasi_layanan['id_informasi_layanan'])) ? $data_informasi_layanan['id_informasi_layanan'] : ''?>"><i class="fas fa-print"></i> Print</a>

                    <a class="btn btn-success btn-sm rounded-pill px-3 mb-2" href="<?=base_url()?>/operator/informasi-layanan-edit/<?= (isset($data_informasi_layanan['jenis_informasi'])) ? str_replace( '_' , '-' , $data_informasi_layanan['jenis_informasi']) : ''?>/<?= (isset($data_informasi_layanan['id_informasi_layanan'])) ? $data_informasi_layanan['id_informasi_layanan'] : ''?>"><i class="fas fa-edit"></i> edit</a>
                  ...
                  <div class="col-8">
                    <?= $data_informasi_layanan['nama_informasi'] ?>
                  </div>
                </div>
              </div>     
...
<div style="margin :auto; padding: 0mm 10mm 10mm 10mm ;  width:210mm; max-width:216mm; background-color:#ffffff;">
    <?php if(isset($data_informasi_layanan['informasi_layanan'])) : ?>
