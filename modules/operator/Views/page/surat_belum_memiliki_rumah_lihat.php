                ...
                <div class="d-flex justify-content-between border-bottom pb-2">
                  ...
                  <div class="">
                    <?php if ($data_surat_belum_memiliki_rumah['status_surat_belum_memiliki_rumah'] == 1) : ?>
                      <a href="<?= base_url() ?>/operator/surat-belum-memiliki-rumah-edit/<?= $data_surat_belum_memiliki_rumah['id_surat_belum_memiliki_rumah'] ?>" class="px-3 py-0 btn btn-sm btn-success round-1 text-sm"><i class="fas fa-edit mr-2"></i> Verifikasi</a>

                    <?php elseif ($data_surat_belum_memiliki_rumah['status_surat_belum_memiliki_rumah'] == 2) : ?>
                      <a href="<?= base_url() ?>/operator/surat-belum-memiliki-rumah-editor/<?= $data_surat_belum_memiliki_rumah['id_surat_belum_memiliki_rumah'] ?>" class="px-3 py-0 btn btn-sm bg-indigo round-1 text-sm"><i class="fas fa-print mr-2"></i> Redaksi Editor</a>
                    <?php endif; ?>
                  </div>
                </div>
                <div class="">
                  ...
                  <table class="table">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?= (isset($data_surat_belum_memiliki_rumah['tujuan_membuat_surat_belum_memiliki_rumah'])) ? $data_surat_belum_memiliki_rumah['tujuan_membuat_surat_belum_memiliki_rumah'] : '' ?></td>
                      </tr>
                      <tr>
                        <td>Tempat Lahir</td>
