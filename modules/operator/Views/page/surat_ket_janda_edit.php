    ...
    <div class="col-12 pt-2">
      <div class="card round-1">
        ...
        <div class="card-body">
          ...
          <form action="<?= base_url() ?>/operator/surat-ket-janda-update" id="surat_ket_janda" method="post" enctype="multipart/form-data">
            <input value="<?= (isset($data_surat_ket_janda['id_surat_ket_janda'])) ? esc($data_surat_ket_janda['id_surat_ket_janda']) : '' ?>" name="id_surat_ket_janda" type="hidden" id="id_surat_ket_janda">
            <div class="form-group row">
              ...
              <div class="col-lg-8">
                <div class="custom-control custom-radio">
                  <input type="radio" name="status_surat_ket_janda" id="status_surat_ket_janda_terima" class="custom-control-input custom-control-input-success" value="2" <?= (isset($data_surat_ket_janda['status_surat_ket_janda']) && $data_surat_ket_janda['status_surat_ket_janda'] == 2) ?  'checked' : '' ?> required>
                  <label for="status_surat_ket_janda_terima" class="custom-control-label">Diterima</label>
                </div>
                <div class="custom-control custom-radio">
                  <input type="radio" name="status_surat_ket_janda" id="status_surat_ket_janda_tolak" class="custom-control-input custom-control-input-danger" value="3" <?= (isset($data_surat_ket_janda['status_surat_ket_janda']) && $data_surat_ket_janda['status_surat_ket_janda'] == 3) ?  'checked' : '' ?>>
                  <label for="status_surat_ket_janda_tolak" class="custom-control-label">Ditolak</label>
                </div>
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-lg-8">
                <textarea name="keterangan_operator" id="keterangan_operator" class="form-control bw-2 border-primary round-1" style="min-height:40px; max-height:100px;"><?= (isset($data_surat_ket_janda['keterangan_operator'])) ? esc($data_surat_ket_janda['keterangan_operator']) : '' ?></textarea>
              </div>
            </div>
            <hr>
            ...
            <div class="form-group row">
              ...
              <div class="col-lg-8">
                <textarea name="keterangan_tiket" id="keterangan_tiket" class="form-control bw-2 border-primary round-1" style="min-height:40px; max-height:100px;"><?= (isset($data_surat_ket_janda['keterangan_tiket'])) ? esc($data_surat_ket_janda['keterangan_tiket']) : '' ?></textarea>
            ...
            <div class="form-group row">
              ...
              <div class="col-lg-8">
                <input value="<?= (isset($data_surat_ket_janda['tanggal_kunjungan_tiket'])) ? $data_surat_ket_janda['tanggal_kunjungan_tiket'] : '' ?>" name="tanggal_kunjungan_tiket" type="date" id="tanggal_kunjungan_tiket" class="form-control bw-2 border-primary round-1">
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-lg-8">
                <div class="row">
                  <div class="col-6">
                    ...
                    <input value="<?= (isset($data_surat_ket_janda['waktu_mulai_tiket'])) ? $data_surat_ket_janda['waktu_mulai_tiket'] : '' ?>" name="waktu_mulai_tiket" type="time" id="waktu_mulai_tiket" class="form-control bw-2 border-primary round-1">
                  </div>
                  <div class="col-6">
                    <span class="text-muted text-sm">Selesai</span>
                    <input value="<?= (isset($data_surat_ket_janda['waktu_selesai_tiket'])) ? $data_surat_ket_janda['waktu_selesai_tiket'] : '' ?>" name="waktu_selesai_tiket" type="time" id="waktu_selesai_tiket" class="form-control bw-2 border-primary round-1">
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="modal-content round-1">
        ...
        <div class="modal-footer d-flex">
          <div class="flex-fill">
            <div class="row">
              <div class="col-6">
                <a href="<?= base_url() ?>/operator/surat-ket-janda" class="font-weight-bold btn-block btn-primary btn round-1">KEMBALI</a>
              </div>
              <div class="col-6">
