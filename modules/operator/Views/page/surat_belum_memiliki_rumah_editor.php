        ...
        <div class="card round-1">
          <div class="card-header pr-3">
            <div class="d-flex justify-content-between">
              <div>
                <p class="font-weight-bold text-lg m-0">Editor Surat Keterangan Belum Memiliki Rumah</p>
              </div>
              <div>
                <a href="<?= base_url() ?>/operator/surat-belum-memiliki-rumah-lihat/<?= (isset($data_surat['id_surat']) && $data_surat['id_surat']) ? $data_surat['id_surat'] : '' ?>" class="btn btn-primary btn-sm rounded-pill"><i class="fas fa-times"></i></a>
              </div>
            </div>
          </div>
          <form autocomplete="off" action="<?= base_url() ?>/operator/surat-belum-memiliki-rumah-editor-update" method="post">
