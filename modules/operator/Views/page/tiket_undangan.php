          ...
          <div class="card-body px-1 px-sm-2 px-md-3 px-lg-4">
            ...
            <div class="row">
              <div class="col-6 col-lg-3">
                <a class="border shadow-sm btn btn-block round-1 mb-2 <?= (isset($status_tiket_state) && $status_tiket_state == 4) ? 'btn-primary' : 'btn-light text-primary ' ?>" href="<?= base_url() ?>/operator/tiket-undangan/hari-ini">
                  Hari ini <i class="fas fa-angle-right"></i>
                </a>
              </div>
              <div class="col-6 col-lg-3">
                <a class="border shadow-sm btn btn-block round-1 mb-2 <?= (isset($status_tiket_state) && $status_tiket_state == 1) ? 'btn-primary' : 'btn-light text-primary ' ?>" href="<?= base_url() ?>/operator/tiket-undangan/menunggu">
                  Menunggu <i class="fas fa-angle-right"></i>
                </a>
              </div>
              <div class="col-6 col-lg-3">
                <a class="border shadow-sm btn btn-block round-1 mb-2 <?= (isset($status_tiket_state) && $status_tiket_state == 2) ? 'btn-primary' : 'btn-light text-primary ' ?>" href="<?= base_url() ?>/operator/tiket-undangan/hadir">
                  Hadir <i class="fas fa-angle-right"></i>
                </a>
              </div>
              <div class="col-6 col-lg-3">
                <a class="border shadow-sm btn btn-block round-1 mb-2 <?= (isset($status_tiket_state) && $status_tiket_state == 3) ? 'btn-primary' : 'btn-light text-primary ' ?>" href="<?= base_url() ?>/operator/tiket-undangan/tidak-hadir">
                      ...
                      <div class="d-flex justify-content-between border-bottom pb-2">
                        ...
                        <div class="">
                          <?php if ($value['status_tiket'] == 1) : ?>
                            <a href="<?= base_url() ?>/operator/tiket-undangan-edit/<?= $value['id_tiket'] ?>" class="px-3 py-0 btn btn-sm btn-success round-1 text-sm"><i class="fas fa-eye mr-2"></i> Lihat</a>
                          <?php endif; ?>
                        </div>
                      </div>
                      <a href="<?= base_url() ?>/operator/tiket-undangan-edit/<?= $value['id_tiket'] ?>">
                        <div class="row text-dark">
                          <div class="col-12 col-lg-6">
                            <div class="row h-100">
                              ...
                              <div class="col-lg-12 col-6">
                                <span class="text-muted font-weight-bold"><?= $value['nomor_tiket'] ?></span>
                              </div>
                            </div>
                          </div>
                          <div class="col-12 col-lg-6">
