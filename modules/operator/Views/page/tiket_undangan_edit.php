        ...
        <div class="row">
          <div class="col-12 pt-2">
            ...
            <div class="d-flex justify-content-between">
              ...
              <div>
              <a href="<?=base_url()?>/operator/tiket-undangan" class="btn btn-primary btn-sm rounded-pill"><i class="fas fa-times"></i></a>
              </div>
            </div> 
            </div>
              ...
              <div class="row">
                ...
                <?php if($data_tiket['status_tiket'] == 1) : ?>
                  <form action="<?=base_url()?>/operator/tiket-undangan-update" id="tiket_undangan" method="post" enctype="multipart/form-data">
                  <input value="<?=(isset($data_tiket['id_tiket']))? esc($data_tiket['id_tiket']) : '' ?>" name="id_tiket" type="hidden"  id="id_tiket">
                  <div class="form-group row">
                      ...
                      <div class="col-lg-8">
                        <div class="custom-control custom-radio">
                          <input type="radio" name="status_tiket" id="status_tiket_terima" class="custom-control-input custom-control-input-success" value="2" <?=(isset($data_tiket['status_tiket']) && $data_tiket['status_tiket'] == 2 )?  'checked' : '' ?> required>
                          <label for="status_tiket_terima" class="custom-control-label">Hadir</label>    
                        </div>
                        <div class="custom-control custom-radio">
                          <input type="radio" name="status_tiket" id="status_tiket_tolak" class="custom-control-input custom-control-input-danger" value="3" <?=(isset($data_tiket['status_tiket']) && $data_tiket['status_tiket'] == 3 )?  'checked' : '' ?>>
                          <label for="status_tiket_tolak" class="custom-control-label">Tidak Hadir</label>    
                        </div>
                      </div>
                  </div>
                                <div class="form-group row">
                ...
                <div class="col-12">
                  <div class="border shadow-sm round-1 d-flex flex-column mb-3 p-2">
                    <div class="d-flex justify-content-between pb-2">
                      ...
                      <div class="d-flex flex-column">
                        <button type="button" class="btn btn-primary round-1 py-0 px-2 " data-toggle="modal" data-target="#modal_data_diri_pemohon"><i class="fas fa-eye pr-2"></i> Data diri</button>
                      </div>
                      <?php else : ?>
                        <div class="d-flex flex-row">
              ...
              <div class="row">
                <div class="col-12">
                      <div class="border shadow-sm round-1 mb-3 p-2">
                        <div class="row">
                          <div class="col-5">Nomor Tiket</div>
                          <div class="col-7">
                          <span class="font-weight-bold">
                      ...
                      <div class="row">
                        ...
                        <div class="row">
                            <div class="col-12 text-center">
                              ...
                              <a href="<?= base_url() ?>/operator/<?=  $data_tiket['filename_surat'] ?>/<?= $data_tiket['id_surat']?>" class="round-1 btn btn-block btn-light text-indigo">
