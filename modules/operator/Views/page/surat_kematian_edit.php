      ...
      <div class="card round-1">
        <div class="card-header pr-3">
          <div class="d-flex justify-content-between">
            <div>
              <p class="font-weight-bold text-lg m-0">Verifikasi Surat Keterangan Kematian</p>
            </div>
            <div>
              <a href="<?= base_url() ?>/operator/surat-kematian" class="btn btn-primary btn-sm rounded-pill"><i class="fas fa-times"></i></a>
            </div>
          </div>
        </div>
        <div class="card-body">
          ...
          <form action="<?= base_url() ?>/operator/surat-kematian-update" id="surat_kematian" method="post" enctype="multipart/form-data">
            <input value="<?= (isset($data_surat_kematian['id_surat_kematian'])) ? esc($data_surat_kematian['id_surat_kematian']) : '' ?>" name="id_surat_kematian" type="hidden" id="id_surat_kematian">
            <div class="form-group row">
              ...
              <div class="col-lg-8">
                <div class="custom-control custom-radio">
                  <input type="radio" name="status_surat_kematian" id="status_surat_kematian_terima" class="custom-control-input custom-control-input-success" value="2" <?= (isset($data_surat_kematian['status_surat_kematian']) && $data_surat_kematian['status_surat_kematian'] == 2) ?  'checked' : '' ?> required>
                  <label for="status_surat_kematian_terima" class="custom-control-label">Diterima</label>
                </div>
                <div class="custom-control custom-radio">
                  <input type="radio" name="status_surat_kematian" id="status_surat_kematian_tolak" class="custom-control-input custom-control-input-danger" value="3" <?= (isset($data_surat_kematian['status_surat_kematian']) && $data_surat_kematian['status_surat_kematian'] == 3) ?  'checked' : '' ?>>
                  <label for="status_surat_kematian_tolak" class="custom-control-label">Ditolak</label>
                </div>
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-lg-8">
                <textarea name="keterangan_operator" id="keterangan_operator" class="form-control bw-2 border-primary round-1" style="min-height:40px; max-height:100px;"><?= (isset($data_surat_kematian['keterangan_operator'])) ? esc($data_surat_kematian['keterangan_operator']) : '' ?></textarea>
              </div>
            </div>
            <hr>
            ...
            <div class="form-group row">
              ...
              <div class="col-lg-8">
                <textarea name="keterangan_tiket" id="keterangan_tiket" class="form-control bw-2 border-primary round-1" style="min-height:40px; max-height:100px;"><?= (isset($data_surat_kematian['keterangan_tiket'])) ? esc($data_surat_kematian['keterangan_tiket']) : '' ?></textarea>
            ...
            <div class="form-group row">
              ...
              <div class="col-lg-8">
                <input value="<?= (isset($data_surat_kematian['tanggal_kunjungan_tiket'])) ? $data_surat_kematian['tanggal_kunjungan_tiket'] : '' ?>" name="tanggal_kunjungan_tiket" type="date" id="tanggal_kunjungan_tiket" class="form-control bw-2 border-primary round-1">
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-lg-8">
                <div class="row">
                  <div class="col-6">
                    ...
                    <input value="<?= (isset($data_surat_kematian['waktu_mulai_tiket'])) ? $data_surat_kematian['waktu_mulai_tiket'] : '' ?>" name="waktu_mulai_tiket" type="time" id="waktu_mulai_tiket" class="form-control bw-2 border-primary round-1">
                  </div>
                  <div class="col-6">
                    <span class="text-muted text-sm">Selesai</span>
                    <input value="<?= (isset($data_surat_kematian['waktu_selesai_tiket'])) ? $data_surat_kematian['waktu_selesai_tiket'] : '' ?>" name="waktu_selesai_tiket" type="time" id="waktu_selesai_tiket" class="form-control bw-2 border-primary round-1">
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="modal-content round-1">
        ...
        <div class="modal-footer d-flex">
          <div class="flex-fill">
            <div class="row">
              <div class="col-6">
                <a href="<?= base_url() ?>/operator/surat-kematian" class="font-weight-bold btn-block btn-primary btn round-1">KEMBALI</a>
              </div>
              <div class="col-6">
