              ...
              <div class="card-header pr-3">
                <div class="d-flex justify-content-between">
                  ...
                  <?php if(isset($title_page)) : ?>
                    <a href="<?=base_url()?>/operator/template-dokumen" class="btn btn-primary btn-sm rounded-pill"><i class="fas fa-times"></i></a>
                  <?php else : ?>
...
<?php if(isset($title_page)) : ?>
  <div class="card-body px-1 px-sm-2 px-md-3 px-lg-4">
            ...
            <div class="col-12">
            <div class="py-1 px-1">
            <a href="<?=base_url()?>/operator/<?= (isset($link_edit)) ? $link_edit : '' ?>" class="btn btn-primary btn-sm rounded-pill"><i class="mr-2 fas fa-plus"></i> Template Baru</a>

            </div>
            </div>
            </div>
            <br>
            <?php if( isset($template_dokumen) && count($template_dokumen) ) :?>
            <div class="row">
              <div id="kartu_keluarga_list" class="col-12">
                <?php foreach($template_dokumen as $value) : ?>
                <div class="border shadow-sm round-1 d-flex flex-column mb-3 p-2">
                  <div class="d-flex justify-content-between border-bottom pb-2">
                    ...
                    <div class="">
                      <a href="<?= base_url() ?>/operator/<?= $link_edit ?>/<?=$value['id_template_dokumen']?>" class="px-3 py-0 btn btn-sm btn-success round-1 text-sm"><i class="fas fa-edit mr-2"></i> Edit</a>
                    
                    </div>
                  </div>
                  <a href="<?=base_url()?>/operator/<?= $link_lihat ?>/<?=$value['id_template_dokumen']?>">
                    <div class="row text-dark">
                      <div class="col-12 col-lg-6">
                        <div class="row h-100">
                          <div class="col-lg-12 col-6">
                            <span class="text-muted">Nama Template</span>
                          </div>
                          <div class="col-lg-12 col-6">
                            <span class="text-muted font-weight-bold"><?=$value['nama_template']?></span>
                          </div>
                        </div>
                      </div>
            ...
            <div class="row">
              <div class="col-12">
                <div class="d-flex justify-content-center"><?= (isset($pager) ) ? $pager->links('template_dokumen', 'sipdesa_pager') : "" ?></div>
              </div>
            </div>
            <?php else : ?>
            <div class="row">
...
<?php else : ?>
          ...
          <a class="btn btn-block my-0 mx-1" href="<?= base_url() ?>/operator/template-dokumen/<?= str_replace('_', '-', $key) ?>">
            <div class="d-flex justify-content-between">
              ...
              <?php if(isset($badge_notif['template_dokumen']) && $badge_notif['template_dokumen'] != 0) : ?>
                  <span class="badge badge-danger mr-3"><?= $badge_notif['template_dokumen'] ?></span>
                <?php endif; ?>
