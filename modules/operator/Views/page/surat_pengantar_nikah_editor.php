        ...
        <div class="col-12">
          ...
          <div class="card-header pr-3">
            <div class="d-flex justify-content-between">
              <div>
              <p class="font-weight-bold text-lg m-0">Editor Surat Pengantar Nikah</p>
              </div>
              <div>
              <a href="<?=base_url()?>/operator/surat-pengantar-nikah-lihat/<?= (isset($data_surat['id_surat']) && $data_surat['id_surat']) ? $data_surat['id_surat'] : '' ?>" class="btn btn-primary btn-sm rounded-pill"><i class="fas fa-times"></i></a>
              </div>
            </div> 
            </div>
            <form autocomplete="off" action="<?= base_url() ?>/operator/surat-pengantar-nikah-editor-update" method="post">
                    ...
                    <div class="col-12 p-3">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                          ...
                          <input value="<?=(isset($data_surat['nama_penanda_tangan']))? esc($data_surat['nama_penanda_tangan']) : '' ?>" name="nama_penanda_tangan" type="text" max-length="150" id="nama_penanda_tangan" alt="Masukan nama lengkap anak" title="Masukan Nama lengkap anak" class="form-control bw-2 round-1 <?= (isset($invalid_info['nama_penanda_tangan'])) ? 'is-invalid' : 'border-primary' ?>" >
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                          ...
                          <input value="<?=(isset($data_surat['jabatan_penanda_tangan']))? esc($data_surat['jabatan_penanda_tangan']) : '' ?>" name="jabatan_penanda_tangan" type="text" max-length="150" id="jabatan_penanda_tangan" alt="Masukan nama lengkap anak" title="Masukan Nama lengkap anak" class="form-control bw-2 round-1 <?= (isset($invalid_info['jabatan_penanda_tangan'])) ? 'is-invalid' : 'border-primary' ?>" >
