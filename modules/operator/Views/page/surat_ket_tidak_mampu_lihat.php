                ...
                <div class="d-flex justify-content-between border-bottom pb-2">
                  ...
                  <div class="">
                    <?php if ($data_surat_ket_tidak_mampu['status_surat_ket_tidak_mampu'] == 1) : ?>
                      <a href="<?= base_url() ?>/operator/surat-ket-tidak-mampu-edit/<?= $data_surat_ket_tidak_mampu['id_surat_ket_tidak_mampu'] ?>" class="px-3 py-0 btn btn-sm btn-success round-1 text-sm"><i class="fas fa-edit mr-2"></i> Verifikasi</a>

                    <?php elseif ($data_surat_ket_tidak_mampu['status_surat_ket_tidak_mampu'] == 2) : ?>
                      <a href="<?= base_url() ?>/operator/surat-ket-tidak-mampu-editor/<?= $data_surat_ket_tidak_mampu['id_surat_ket_tidak_mampu'] ?>" class="px-3 py-0 btn btn-sm bg-indigo round-1 text-sm"><i class="fas fa-print mr-2"></i> Redaksi Editor</a>
                    <?php endif; ?>
                  </div>
                </div>
                <div class="">
                  ...
                  <table class="table">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?= (isset($data_surat_ket_tidak_mampu['tujuan_membuat_surat_ket_tidak_mampu'])) ? $data_surat_ket_tidak_mampu['tujuan_membuat_surat_ket_tidak_mampu'] : '' ?></td>
                      </tr>
                      <tr>
                        <td>Tempat Lahir</td>
