<script>
    ...
    function goto_form(id) {
        ...
        for (let i = 0; i < arr_class.length; i++) {
            if ($('#tab_' + arr_class[i] + '_button').hasClass('active')) {
                $('#tab_' + arr_class[i] + '_button').removeClass('active');
            }
            if ($('#tab_' + arr_class[i]).hasClass('active')) {
                $('#tab_' + arr_class[i]).removeClass('active');
            }
            if ($('#tab_' + arr_class[i]).hasClass('show')) {
                $('#tab_' + arr_class[i]).removeClass('show');
            }
        }
