      ...
      <div class="card round-1">
        <div class="card-header pr-3">
          <div class="d-flex justify-content-between">
            <div>
              <p class="font-weight-bold text-lg m-0">Detail Surat Keterangan Janda</p>
            </div>
            <div>
              <?php if (isset($data_surat_ket_janda['status_surat_ket_janda'])) {
                switch ($data_surat_ket_janda['status_surat_ket_janda']) {
                  case 1:
                    $filename = 'diproses';
                    break;
                  case 2:
              ...
              ?>
              <a href="<?= base_url() ?>/penduduk/surat-ket-janda<?= (isset($filename)) ? '/' . $filename : '' ?>" class="btn btn-primary btn-sm rounded-pill"><i class="fas fa-times"></i></a>
            </div>
          </div>
        </div>
        <div class="card-body">
                ...
                <div class="d-flex justify-content-between border-bottom pb-2">
                  ...
                  <div class="">
                    <?php if ($data_surat_ket_janda['status_surat_ket_janda'] == 1) : ?>
                      <a href="<?= base_url() ?>/penduduk/surat-ket-janda-edit/<?= $data_surat_ket_janda['id_surat_ket_janda'] ?>" class="px-3 py-0 btn btn-sm btn-success round-1 text-sm"><i class="fas fa-edit"></i> Edit</a>
                    <?php endif; ?>
                  </div>
                </div>
                <div class="">
                ...
                <div class="col-12">
                  ...
                  <table class="table">
                    <tbody>
                      ...
                      <tr>
                        <td>Jenis Kelamin</td>
                        <td><?= (isset($data_surat_ket_janda['jenis_kelamin_ket_janda'])) ? $data_surat_ket_janda['jenis_kelamin_ket_janda'] : '' ?></td>
                      </tr>
                      <tr>
                        <td>Tempat Lahir</td>
                      ...
                      <tr>
                        <td>Agama</td>
                        <td><?= (isset($data_surat_ket_janda['agama_ket_janda'])) ? $data_surat_ket_janda['agama_ket_janda'] : '' ?></td>
                      </tr>
                      <tr>
                        <td>Pekerjaan</td>
                        <td><?= (isset($data_surat_ket_janda['pekerjaan_ket_janda'])) ? $data_surat_ket_janda['pekerjaan_ket_janda'] : '' ?></td>
                      </tr>
                      <tr>
                        <td>Alamat</td>
                        <td><?= (isset($data_surat_ket_janda['alamat_ket_janda'])) ? $data_surat_ket_janda['alamat_ket_janda'] : '' ?></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
