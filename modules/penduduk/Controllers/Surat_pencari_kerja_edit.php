...
class Surat_pencari_kerja_edit extends BaseController
{
    ...
    public function index($param = '')
    {
        ...
        if ($param != '' && $id_user) {
            $data_surat_pencari_kerja = $this->tbl_surat_pencari_kerja->where(['id_surat_pencari_kerja' => intval($param), 'status_surat_pencari_kerja' => 1, 'id_user' => $id_user])->first();
        }
        ...
        if ($this->session->getFlashdata('inp_val')) {
            ...
            if (isset($data_surat_pencari_kerja['id_surat_pencari_kerja']) && $data_surat_pencari_kerja['id_surat_pencari_kerja'] != '') {
                $this->data['data_surat_pencari_kerja']['id_surat_pencari_kerja'] = $data_surat_pencari_kerja['id_surat_pencari_kerja'];
            }
        }
        ...
        //     if (!isset($this->data['data_surat_pencari_kerja']['link_' . $value]) || $this->data['data_surat_pencari_kerja']['link_' . $value] == '') {
        //         if (isset($data_surat_pencari_kerja['link_' . $value])) {
        //             $this->data['data_surat_pencari_kerja']['link_' . $value] = $data_surat_pencari_kerja['link_' . $value];
        //         }
        //     }
        // }
        ...
        if (isset($this->data['data_surat_pencari_kerja'])) {
            $this->data['data_surat_pencari_kerja'] = $this->arr_wilayah($this->data['data_surat_pencari_kerja']);
        }
        ...
        $this->data['v']['page'] = 'surat_pencari_kerja_edit';
        $this->data['v']['script'] = 'surat_pencari_kerja_edit';
