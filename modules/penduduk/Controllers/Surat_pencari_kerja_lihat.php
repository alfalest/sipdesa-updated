...
class Surat_pencari_kerja_lihat extends BaseController
{
    ...
    public function index($param = '')
    {
        ...
        if ($param != '' && $id_user) {
            $data_surat_pencari_kerja = $this->tbl_surat_pencari_kerja->where(['id_surat_pencari_kerja' => intval($param), 'id_user' => $id_user])->first();
        }

        if ($data_surat_pencari_kerja) {

            if (isset($data_surat_pencari_kerja['belum_dilihat']) && $data_surat_pencari_kerja['belum_dilihat'] == 1) {
                if ($this->tbl_surat_pencari_kerja->set(['belum_dilihat' => null])->where(['id_surat_pencari_kerja' => intval($param), 'id_user' => $id_user])->update()) {
                    $data_surat_pencari_kerja['belum_dilihat'] = null;
                }
            }
        ...
        if ($this->session->getFlashdata('inp_val')) {
            $this->data['data_surat_pencari_kerja'] = $this->session->getFlashdata('inp_val');
            if (isset($data_surat_pencari_kerja['id_perubahan_kk']) && $data_surat_pencari_kerja['id_perubahan_kk'] != '') {
                $this->data['data_surat_pencari_kerja']['id_perubahan_kk'] = $data_surat_pencari_kerja['id_perubahan_kk'];
            }
        }
