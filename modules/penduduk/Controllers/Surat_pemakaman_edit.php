...
class Surat_pemakaman_edit extends BaseController
{
    ...
    public function index($param = '')
    {
        ...
        if ($param != '' && $id_user) {
            $data_surat_pemakaman = $this->tbl_surat_pemakaman->where(['id_surat_pemakaman' => intval($param), 'status_surat_pemakaman' => 1, 'id_user' => $id_user])->first();
        }
        ...
        if ($this->session->getFlashdata('inp_val')) {
            ...
            if (isset($data_surat_pemakaman['id_surat_pemakaman']) && $data_surat_pemakaman['id_surat_pemakaman'] != '') {
                $this->data['data_surat_pemakaman']['id_surat_pemakaman'] = $data_surat_pemakaman['id_surat_pemakaman'];
            }
        }
        ...
        //     if (!isset($this->data['data_surat_pemakaman']['link_' . $value]) || $this->data['data_surat_pemakaman']['link_' . $value] == '') {
        //         if (isset($data_surat_pemakaman['link_' . $value])) {
        //             $this->data['data_surat_pemakaman']['link_' . $value] = $data_surat_pemakaman['link_' . $value];
        //         }
        //     }
        // }
        ...
        if (isset($this->data['data_surat_pemakaman'])) {
            $this->data['data_surat_pemakaman'] = $this->arr_wilayah($this->data['data_surat_pemakaman']);
        }
        ...
        $this->data['v']['page'] = 'surat_pemakaman_edit';
        $this->data['v']['script'] = 'surat_pemakaman_edit';
