...
class Surat_kematian_edit extends BaseController
{
    ...
    public function index($param = '')
    {
        ...
        if ($param != '' && $id_user) {
            $data_surat_kematian = $this->tbl_surat_kematian->where(['id_surat_kematian' => intval($param), '	status_surat_kematian' => 1, 'id_user' => $id_user])->first();
        }
        ...
        if ($this->session->getFlashdata('inp_val')) {
            ...
            if (isset($data_surat_kematian['id_surat_kematian']) && $data_surat_kematian['id_surat_kematian'] != '') {
                $this->data['data_surat_kematian']['id_surat_kematian'] = $data_surat_kematian['id_surat_kematian'];
            }
        }
        ...
        //     if (!isset($this->data['data_surat_kematian']['link_' . $value]) || $this->data['data_surat_kematian']['link_' . $value] == '') {
        //         if (isset($data_surat_kematian['link_' . $value])) {
        //             $this->data['data_surat_kematian']['link_' . $value] = $data_surat_kematian['link_' . $value];
        //         }
        //     }
        // }
        ...
        if (isset($this->data['data_surat_kematian'])) {
            $this->data['data_surat_kematian'] = $this->arr_wilayah($this->data['data_surat_kematian']);
        }
        ...
        $this->data['v']['page'] = 'surat_kematian_edit';
        $this->data['v']['script'] = 'surat_kematian_edit';
