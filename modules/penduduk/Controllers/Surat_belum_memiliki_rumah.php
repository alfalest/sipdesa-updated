...
class Surat_belum_memiliki_rumah extends BaseController
{
    ...
    public function index($param = '')
    {
        ...
        $this->data['kk_proses'] = $this->Tbl_surat_belum_memiliki_rumah->where(['status_surat_belum_memiliki_rumah' => $status_perubahan, 'id_user' => $id_user])->orderBy("update_time", "DESC")->paginate(5, 'sk');
