...
use Config\Paths;
class Surat_kelahiran_edit extends BaseController
{
    ...
    public function index($param = '')
    {
        ...
        if($param != '' && $id_user){
            $data_surat_kelahiran = $this->tbl_surat_kelahiran->where(['id_surat_kelahiran' => intval($param), '	status_surat_kelahiran' => 1, 'id_user' => $id_user])->first();
        }
        ...
        if($this->session->getFlashdata('inp_val')){
            ...
            if(isset($data_surat_kelahiran['id_surat_kelahiran']) && $data_surat_kelahiran['id_surat_kelahiran'] != ''){
                $this->data['data_surat_kelahiran']['id_surat_kelahiran'] = $data_surat_kelahiran['id_surat_kelahiran'];
            }
        }
        ...
        foreach ($arr_post_photo as $key => $value) {
            if(!isset($this->data['data_surat_kelahiran']['link_'.$value]) || $this->data['data_surat_kelahiran']['link_'.$value] == ''){
                if(isset($data_surat_kelahiran['link_'.$value])){
                    $this->data['data_surat_kelahiran']['link_'.$value] = $data_surat_kelahiran['link_'.$value];
                }
            }
        }
        ...
        if(isset($this->data['data_surat_kelahiran'])){
                $this->data['data_surat_kelahiran'] = $this->arr_wilayah($this->data['data_surat_kelahiran'], '_anak');
                $this->data['data_surat_kelahiran'] = $this->arr_wilayah($this->data['data_surat_kelahiran'], '_ayah');
                $this->data['data_surat_kelahiran'] = $this->arr_wilayah($this->data['data_surat_kelahiran'], '_ibu');
        }
        ...
        $this->data['v']['page'] = 'surat_kelahiran_edit';
        $this->data['v']['script'] = 'surat_kelahiran_edit';
