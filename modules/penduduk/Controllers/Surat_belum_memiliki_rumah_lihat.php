...
class Surat_belum_memiliki_rumah_lihat extends BaseController
{
    ...
    public function index($param = '')
    {
        ...
        if ($param != '' && $id_user) {
            $data_surat_belum_memiliki_rumah = $this->tbl_surat_belum_memiliki_rumah->where(['id_surat_belum_memiliki_rumah' => intval($param), 'id_user' => $id_user])->first();
        }

        if ($data_surat_belum_memiliki_rumah) {

            if (isset($data_surat_belum_memiliki_rumah['belum_dilihat']) && $data_surat_belum_memiliki_rumah['belum_dilihat'] == 1) {
                if ($this->tbl_surat_belum_memiliki_rumah->set(['belum_dilihat' => null])->where(['id_surat_belum_memiliki_rumah' => intval($param), 'id_user' => $id_user])->update()) {
                    $data_surat_belum_memiliki_rumah['belum_dilihat'] = null;
                }
            }
        ...
        if ($this->session->getFlashdata('inp_val')) {
            ...
            if (isset($data_surat_belum_memiliki_rumah['id_perubahan_kk']) && $data_surat_belum_memiliki_rumah['id_perubahan_kk'] != '') {
                $this->data['data_surat_belum_memiliki_rumah']['id_perubahan_kk'] = $data_surat_belum_memiliki_rumah['id_perubahan_kk'];
            }
        }
