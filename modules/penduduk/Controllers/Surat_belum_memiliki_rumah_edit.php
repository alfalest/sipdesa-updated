...
class Surat_belum_memiliki_rumah_edit extends BaseController
{
    ...
    public function index($param = '')
    {
        ...
        if ($param != '' && $id_user) {
            $data_surat_belum_memiliki_rumah = $this->tbl_surat_belum_memiliki_rumah->where(['id_surat_belum_memiliki_rumah' => intval($param), 'status_surat_belum_memiliki_rumah' => 1, 'id_user' => $id_user])->first();
        }
        ...
        if ($this->session->getFlashdata('inp_val')) {
            $this->data['data_surat_belum_memiliki_rumah'] = $this->session->getFlashdata('inp_val');
            if (isset($data_surat_belum_memiliki_rumah['id_surat_belum_memiliki_rumah']) && $data_surat_belum_memiliki_rumah['id_surat_belum_memiliki_rumah'] != '') {
                $this->data['data_surat_belum_memiliki_rumah']['id_surat_belum_memiliki_rumah'] = $data_surat_belum_memiliki_rumah['id_surat_belum_memiliki_rumah'];
            }
        }
        ...
        //     if (!isset($this->data['data_surat_belum_memiliki_rumah']['link_' . $value]) || $this->data['data_surat_belum_memiliki_rumah']['link_' . $value] == '') {
        //         if (isset($data_surat_belum_memiliki_rumah['link_' . $value])) {
        //             $this->data['data_surat_belum_memiliki_rumah']['link_' . $value] = $data_surat_belum_memiliki_rumah['link_' . $value];
        //         }
        //     }
        // }
        ...
        if (isset($this->data['data_surat_belum_memiliki_rumah'])) {
            $this->data['data_surat_belum_memiliki_rumah'] = $this->arr_wilayah($this->data['data_surat_belum_memiliki_rumah']);
        }
