...
class Tiket_undangan extends BaseController
{
    ...
    public function index($param = '')
    {
        ...
        $per_page = 5;
        if (isset($hari_ini)) {
            $arr_where = ['tbl_tiket.id_user' =>  $id_user, 'tbl_tiket.status_tiket' =>  $status_tiket_state, 'tbl_tiket.tanggal_kunjungan_tiket' => $hari_ini];
        } else {
            $arr_where = ['tbl_tiket.id_user' =>  $id_user, 'tbl_tiket.status_tiket' =>  $status_tiket_state];
        }
