...
class Surat_pengantar_nikah_edit extends BaseController
{
    ...
    public function index($param = '')
    {
        ...
        if($param != '' && $id_user){
            $data_surat_pengantar_nikah = $this->tbl_surat_pengantar_nikah->where(['id_surat_pengantar_nikah' => intval($param), '	status_surat_pengantar_nikah' => 1, 'id_user' => $id_user])->first();
        }
        ...
        if($this->session->getFlashdata('inp_val')){
            ...
            if(isset($data_surat_pengantar_nikah['id_surat_pengantar_nikah']) && $data_surat_pengantar_nikah['id_surat_pengantar_nikah'] != ''){
                $this->data['data_surat_pengantar_nikah']['id_surat_pengantar_nikah'] = $data_surat_pengantar_nikah['id_surat_pengantar_nikah'];
            }
        }
        ...
        foreach ($arr_post_photo as $key => $value) {
            if(!isset($this->data['data_surat_pengantar_nikah']['link_'.$value]) || $this->data['data_surat_pengantar_nikah']['link_'.$value] == ''){
                if(isset($data_surat_pengantar_nikah['link_'.$value])){
                    $this->data['data_surat_pengantar_nikah']['link_'.$value] = $data_surat_pengantar_nikah['link_'.$value];
                }
            }
        }
        ...
        if(isset($this->data['data_surat_pengantar_nikah'])){
            $this->data['data_surat_pengantar_nikah'] = $this->arr_wilayah($this->data['data_surat_pengantar_nikah'], '_pemohon');
            $this->data['data_surat_pengantar_nikah'] = $this->arr_wilayah($this->data['data_surat_pengantar_nikah'], '_pasangan');
            ...
            $this->data['data_surat_pengantar_nikah'] = $this->arr_wilayah($this->data['data_surat_pengantar_nikah'], '_akad');
        }
