...
class Surat_catatan_kepolisian_lihat extends BaseController
{
    ...
    public function index($param = '')
    {
        ...
        if ($param != '' && $id_user) {
            $data_surat_catatan_kepolisian = $this->tbl_surat_catatan_kepolisian->where(['id_surat_catatan_kepolisian' => intval($param), 'id_user' => $id_user])->first();
        }

        if ($data_surat_catatan_kepolisian) {

            if (isset($data_surat_catatan_kepolisian['belum_dilihat']) && $data_surat_catatan_kepolisian['belum_dilihat'] == 1) {
                if ($this->tbl_surat_catatan_kepolisian->set(['belum_dilihat' => null])->where(['id_surat_catatan_kepolisian' => intval($param), 'id_user' => $id_user])->update()) {
                    $data_surat_catatan_kepolisian['belum_dilihat'] = null;
                }
            }
        ...
        if ($this->session->getFlashdata('inp_val')) {
            ...
            if (isset($data_surat_catatan_kepolisian['id_perubahan_kk']) && $data_surat_catatan_kepolisian['id_perubahan_kk'] != '') {
                $this->data['data_surat_catatan_kepolisian']['id_perubahan_kk'] = $data_surat_catatan_kepolisian['id_perubahan_kk'];
            }
        }
