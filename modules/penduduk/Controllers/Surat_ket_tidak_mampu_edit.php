...
class Surat_ket_tidak_mampu_edit extends BaseController
{
    ...
    public function index($param = '')
    {
        ...
        if ($param != '' && $id_user) {
            $data_surat_ket_tidak_mampu = $this->tbl_surat_ket_tidak_mampu->where(['id_surat_ket_tidak_mampu' => intval($param), 'status_surat_ket_tidak_mampu' => 1, 'id_user' => $id_user])->first();
        }
        ...
        if ($this->session->getFlashdata('inp_val')) {
            ...
            if (isset($data_surat_ket_tidak_mampu['id_surat_ket_tidak_mampu']) && $data_surat_ket_tidak_mampu['id_surat_ket_tidak_mampu'] != '') {
                $this->data['data_surat_ket_tidak_mampu']['id_surat_ket_tidak_mampu'] = $data_surat_ket_tidak_mampu['id_surat_ket_tidak_mampu'];
            }
        }
        ...
        //     if (!isset($this->data['data_surat_ket_tidak_mampu']['link_' . $value]) || $this->data['data_surat_ket_tidak_mampu']['link_' . $value] == '') {
        //         if (isset($data_surat_ket_tidak_mampu['link_' . $value])) {
        //             $this->data['data_surat_ket_tidak_mampu']['link_' . $value] = $data_surat_ket_tidak_mampu['link_' . $value];
        //         }
        //     }
        // }
        ...
        if (isset($this->data['data_surat_ket_tidak_mampu'])) {
            $this->data['data_surat_ket_tidak_mampu'] = $this->arr_wilayah($this->data['data_surat_ket_tidak_mampu']);
        }
        ...
        $this->data['v']['page'] = 'surat_ket_tidak_mampu_edit';
        $this->data['v']['script'] = 'surat_ket_tidak_mampu_edit';
