...
class Surat_ket_janda_edit extends BaseController
{
    ...
    public function index($param = '')
    {
        ...
        if ($param != '' && $id_user) {
            $data_surat_ket_janda = $this->tbl_surat_ket_janda->where(['id_surat_ket_janda' => intval($param), 'status_surat_ket_janda' => 1, 'id_user' => $id_user])->first();
        }
        ...
        if ($this->session->getFlashdata('inp_val')) {
            ...
            if (isset($data_surat_ket_janda['id_surat_ket_janda']) && $data_surat_ket_janda['id_surat_ket_janda'] != '') {
                $this->data['data_surat_ket_janda']['id_surat_ket_janda'] = $data_surat_ket_janda['id_surat_ket_janda'];
            }
        }
        ...
        //     if (!isset($this->data['data_surat_ket_janda']['link_' . $value]) || $this->data['data_surat_ket_janda']['link_' . $value] == '') {
        //         if (isset($data_surat_ket_janda['link_' . $value])) {
        //             $this->data['data_surat_ket_janda']['link_' . $value] = $data_surat_ket_janda['link_' . $value];
        //         }
        //     }
        // }
        ...
        if (isset($this->data['data_surat_ket_janda'])) {
            $this->data['data_surat_ket_janda'] = $this->arr_wilayah($this->data['data_surat_ket_janda']);
        }
