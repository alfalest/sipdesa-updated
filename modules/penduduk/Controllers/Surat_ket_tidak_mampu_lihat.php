...
class Surat_ket_tidak_mampu_lihat extends BaseController
{
    ...
    public function index($param = '')
    {
        ...
        if ($param != '' && $id_user) {
            $data_surat_ket_tidak_mampu = $this->tbl_surat_ket_tidak_mampu->where(['id_surat_ket_tidak_mampu' => intval($param), 'id_user' => $id_user])->first();
        }

        if ($data_surat_ket_tidak_mampu) {

            if (isset($data_surat_ket_tidak_mampu['belum_dilihat']) && $data_surat_ket_tidak_mampu['belum_dilihat'] == 1) {
                if ($this->tbl_surat_ket_tidak_mampu->set(['belum_dilihat' => null])->where(['id_surat_ket_tidak_mampu' => intval($param), 'id_user' => $id_user])->update()) {
                    $data_surat_ket_tidak_mampu['belum_dilihat'] = null;
                }
            }
        ...
        if ($this->session->getFlashdata('inp_val')) {
            $this->data['data_surat_ket_tidak_mampu'] = $this->session->getFlashdata('inp_val');
            if (isset($data_surat_ket_tidak_mampu['id_perubahan_kk']) && $data_surat_ket_tidak_mampu['id_perubahan_kk'] != '') {
                $this->data['data_surat_ket_tidak_mampu']['id_perubahan_kk'] = $data_surat_ket_tidak_mampu['id_perubahan_kk'];
            }
        }
